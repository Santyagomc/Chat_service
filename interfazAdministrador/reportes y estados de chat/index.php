...
<head>
  ...
  <link href="https://use.fontawesome.com/releases/v5.0.7/css/all.css" rel="stylesheet">
    ...
    <title>Estado de chats</title>
</head>
<body >
	
      <iframe src="salas/chat1/chat1.php" frameborder="0" name="sala1"  style="width: 100%; height: 700px; overflow-y: scroll;">
      	
      </iframe>
     
    <div class="row text-center">
    	<div class="col-md-3">
       		<a  href="salas/chat1/chat1.php" class="btn btn-outline-info" target="sala1" >Sala 1</a>
    	</div>
    	<div class="col-md-3"> 
      		<a  href="salas/chat2/chat2.php" target="sala1" class="btn btn-outline-info">Sala 2 </a>
    	</div>
    	<div class="col-md-3">
      		<a  href="salas/chat3/chat3.php" target="sala1" class="btn btn-outline-info">Sala 3</a>
    	</div>
    	<div class="col-md-3">
