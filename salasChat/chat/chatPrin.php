...
<html lang="es">
  ...
  <body class= "bg-dark" onload="ajax();">
    ...
    <div class="container cont bg-white"> <!-- contenedor-->
      ...
      <h1 class="text-center">Bienvenid@ <?php echo " ".$userName; ?> a CHAT-SERVICE</h1>
      </div>
      ...
      <form method="post" action="chatPrin.php">
        ...
        <div class="wrap-input100 validate-input" data-validate="Escribe tu mensaje">
            <textarea class="input100" name="mensaje" required ></textarea>
  ...
  <div class="modal-dialog">
      ...
      <form action="eliminarMensaje.php" method="post">
        <div class="modal-body">
          ...
          <div class="wrap-input100 validate-input" data-validate="El codigo es requerido">
            <input class="input100" type="password" name="clave" required autocomplete="off"> 
            <span class="focus-input100"></span>
            <span class="label-input100">Contraseña administrador</span>
          </div>
          <div class="alert alert-info" role="alert">
                Debes ingresar tu <strong>Contraseña </strong>si eres asesor.
          </div>
    ...
    <?php
      if(isset($_POST["enviar"])){ //validacion del nomrbe y el mensaje
          ...
          $consulta = "INSERT INTO chat (mensaje,salaChat,idUser) VALUES ('$mensaje','1','$id')" ; //insertar en la base de datos 
